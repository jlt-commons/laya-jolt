(ns lev.workflows
  ...
  (underscores in the file name become dashes) with
    ...
    (defn constraints ([] ...) ([opts] ...)) ; optional: lev.constraints over the
  ...
  ~/.config/lev/workflows or wherever config.edn :workflow-dirs / the
  LEV_WORKFLOWS variable point (see lev.config/workflow-dirs)."
